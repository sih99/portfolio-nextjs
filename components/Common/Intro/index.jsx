...
const Intro = () => {
  return (
    <>
      {/* fixed at top */}
      <div className="headerr z-50 absolute  backdrop-blur-sm inset-y-0 h-40 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <span className="text-sm text-Gray700 text-center mt-2">{DESIGNATION}</span>
        </div>
      </div>
